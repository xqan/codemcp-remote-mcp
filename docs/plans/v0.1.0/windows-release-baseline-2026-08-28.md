# codemcp-remote v0.1.0 Windows Release Baseline Plan (Frozen)

> Frozen: 2026-08-30
> Archived from `docs/implementation-plan.md`; content is preserved, with only the title, archival metadata, relative links and trailing Markdown break whitespace adjusted for the archive location.
> Successor: [`../../implementation-plan.md`](../../implementation-plan.md)

> Updated: 2026-08-28
> Release target: `v0.1.0`
> Status: **PRE-RELEASE / RELEASE GATES IN PROGRESS**
> Open-source release plan: [`open-source-readiness-plan.md`](open-source-readiness-plan.md)
